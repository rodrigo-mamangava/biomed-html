...
<div class="box-03-titulo container">
	<div class="row titulo-box-03">
		<div class="col-sm-12">
			<h3>Desde 1969 o melhor suporte aos médicos brasileiros</h3>
		</div>
	</div>
...
<div class="mapa-suporte-tec container">
	<div class="row">
		<div class="col-sm-6">
			...
			Maecenas consectetur ullamcorper velit, ac sodales risus viverra in. 
			Maecenas faucibus mauris ac lacus ultrices ornare. 
			Vestibulum imperdiet tellus tristique elit mattis, ac convallis felis luctus. 
			Aenean sollicitudin facilisis quam sit amet sagittis. 
			Ut sollicitudin in magna eu rutrum. 
			Phasellus sed lacus at tortor scelerisque rutrum in eget quam.
			</p>
		...
		<div class="col-sm-6 lista">
			<div class="col-sm-6">
				...
				<p class="local">Local 02</p>
				<p class="local">Local 03</p>	
			</div>
			<div class="col-sm-6">
				<p class="nome-estado">Rio de Janeiro</p>
				<p class="local">Local 01</p>
